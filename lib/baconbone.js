...
(function() {
  ...
  Baconbone.View = (function(_super) {
    ...
    View.prototype.findChild = function(modelOrView) {
      var view, _j, _len1, _ref;
      if (this._children.indexOf(modelOrView) >= 0) {
        return modelOrView;
      }
      _ref = this._children;
      for (_j = 0, _len1 = _ref.length; _j < _len1; _j++) {
        view = _ref[_j];
        if (view.model.id === modelOrView.id) {
          return view;
        }
      }
    };
  ...
  Baconbone.ModelView = (function(_super) {
    ...
    ModelView.prototype.renderTemplate = function(data) {
      return '';
    };
    ...
    ModelView.prototype.render = function() {
      ...
      this.$el.html(this.renderTemplate(this.data()));
